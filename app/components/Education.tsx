        ...
        <ul className="timeline timeline-snap-icon max-md:timeline-compact timeline-vertical">
          <li>
            ...
            <div className="timeline-start md:text-end mb-10">
              <div className="card card-compact w-96 bg-base-100 shadow-xl">
                <figure><Image height={600} width={500} src="https://images.hindustantimes.com/rf/image_size_960x540/HT/p2/2019/09/12/Pictures/_fa7b4cb0-d521-11e9-98d7-43b78744c7ea.jpg" alt="Shoes" /></figure>
          ...
          <li>
            ...
            <div className="timeline-end mb-10">
                <div className="card card-compact w-96 bg-base-100 shadow-xl">
                    <figure><Image src="https://images.hindustantimes.com/rf/image_size_960x540/HT/p2/2019/09/12/Pictures/_fa7b4cb0-d521-11e9-98d7-43b78744c7ea.jpg" alt="Shoes" height={600} width={500} /></figure>
                    <div className="card-body">
            ...
            <li>
                ...
                <div className="timeline-start md:text-end mb-10">
                    <div className="card card-compact w-96 bg-base-100 shadow-xl">
                        <figure><Image height={600} width={500} src="https://qph.cf2.quoracdn.net/main-qimg-76d512d1dda6e9c6fadd11fb59a8f73d-lq" alt="Shoes" /></figure>
                        <div className="card-body">
